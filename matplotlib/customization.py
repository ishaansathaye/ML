...
def graph_data(stock):
    ...
    ax1.fill_between(df.index, df.Close, df.Close[0], where=(df.Close > df.Close[0]), facecolor='g', alpha=0.5)  # alpha: degree of transparency, between close and close[0] it fills
